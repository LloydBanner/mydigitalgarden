---
{"dg-publish":true,"permalink":"/main-notes/maybe-you-don-t-always-need-a-goal/","tags":["thoughts","feed","developing"],"created":"26-08-2025","updated":"22-12-2025"}
---
...
After pushing and moving in I had not let myself relax until recently. I needed to fix up the house or find another project. I have made a little home server, done lots of decorating, and then I started making a video game. I convinced myself that making the game would be worthwhile, because I wasn't happy with my work and wanted to do my own thing, and started spending all my free time on it when I was already feeling a little down. For a month or so I managed to increase my motivation, I had 3D movement going in [[Software Tools/Godot\|Godot]], and some spells, along with a level building mechanism using [[Game development/Trenchbroom\|Trenchbroom]] a level editor for [[Sources/Quake\|Quake]] using ideas from [[Sources/Blargis\|Blargis]]' dev logs on Youtube. 

Then I hit a brick wall. My motivation was completely zapped. I knew I could make the game, I knew I could finish my [[Main Notes/2025 Reading One Book a Month\|2025 Reading One Book a Month]] challenge (I actually did end up doing this but only because I started reading and really got into [[Sources/Dungeon Crawler Carl (series)\|Dungeon Crawler Carl]]), and I knew I could keep pushing myself. I decided it wasn't worth it though. I was not happy anymore. I had finished all my past goals and they weren't making me happy anymore. It always feels good to finish something and it is worth pushing through the hard parts often, but really I think you should enjoy the process. 
...
The final thing I have done is change my perspective. In reading [[Sources/The Courage to be Disliked\|The Courage to be Disliked]] and watching [[Sources/Newel of Knowledge\|Newel of Knowledge]] on Youtube I have seen a perspective that I lost. I used to be endlessly optimistic about the world but have recently found myself calling myself a "realist" which is usually just the shield of a pessimist. So I have decided not to care what people think, to believe that people are good and want the best and to believe in humanity as a whole.
...
- [[Main Notes/2025 Reading One Book a Month\|2025 Reading One Book a Month]]
...
- [[Sources/Quake\|Quake]]
- [[Software Tools/Godot\|Godot]]
- [[Game development/Trenchbroom\|Trenchbroom]]
- [[Sources/Newel of Knowledge\|Newel of Knowledge]]
- [[Sources/Blargis\|Blargis]]