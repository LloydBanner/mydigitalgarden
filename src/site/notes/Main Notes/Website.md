...
I use [Obsidian](https://obsidian.md/) to write all of my notes. [Obsidian](https://obsidian.md/) has a plugin called [Digital Garden](https://dg-docs.ole.dev/) which uses [Github](https://github.com/) and [Vercel](https://vercel.com/) to store and host the website. It's actually pretty simple to set up and if you follow the [Digital Garden](https://dg-docs.ole.dev/) getting started page I think anyone with a basic knowledge of computers could do it. I'm also using [Giscus](https://giscus.app/) for comments and [ImprovMX](https://app.improvmx.com/) for email forwarding.